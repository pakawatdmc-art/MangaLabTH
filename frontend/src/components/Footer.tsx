    ...
    <footer className="border-t border-white/5 bg-surface-300 pb-20 md:pb-0">
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:gap-8">
          ...
          {/* Categories */}
          <nav aria-label="หมวดหมู่มังงะ" className="col-span-1 md:col-span-2 lg:col-span-1">
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-gray-400">
              หมวดหมู่
            </h3>
            <ul className="grid grid-cols-2 gap-x-6 gap-y-2 lg:grid-cols-1 lg:gap-x-0 lg:max-h-48 lg:flex lg:flex-col lg:flex-wrap">
          ...
          {/* Quick Links */}
          <nav aria-label="ลิงก์ด่วน" className="col-span-1 lg:col-span-1 lg:pl-10">
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-gray-400">
              ลิงก์ด่วน
            </h3>
